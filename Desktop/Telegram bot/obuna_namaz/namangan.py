...
'''Namangan'''
namangan = dict(db.get_namangan()[0])
keysNam = [*namangan.keys()]
valueNam = [*namangan.values()]

set_namoz_time(valueNam[6],valueNam[7],valueNam[8],valueNam[9],valueNam[10],valueNam[11])